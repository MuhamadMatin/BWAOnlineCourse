        ...
        <div class="left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="flex items-center justify-center w-full h-full">
                <form method="POST" action="{{ route('register') }}"
                    ...
                    <h1 class="text-2xl font-bold leading-9">Sign Up</h1>
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('images/icons/profile.svg') }}" class="object-contain w-full h-full"
                                    alt="icon">
                            </div>
                            <input type="text"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('images/icons/sms.svg') }}" class="object-contain w-full h-full"
                                    alt="icon">
                            </div>
                            <input type="email"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('images/icons/lock.svg') }}" class="object-contain w-full h-full"
                                    alt="icon">
                            </div>
                            <input type="password"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
            ...
            <div class="h-full w-full flex flex-col items-center justify-center pt-[66px] gap-[100px]">
                <div class="w-[500px] h-[360px] flex shrink-0 overflow-hidden">
                    <img src="{{ asset('images/thumbnail/sign-in-illustration.png') }}"
                        class="object-contain w-full h-full" alt="banner">
                </div>
                <div class="w-full overflow-hidden logos">
