...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full flex-wrap pb-[30px]">
            ...
            <div class="header flex-wrap ml-[70px] pr-[70px] w-full flex items-center justify-between mt-10">
                <div class="flex items-center gap-6">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{ Storage::url($course->cover) }}" class="object-cover w-full h-full rounded-full"
                            alt="icon">
                        <p
            ...
            <div id="course-test" class="mx-[50px] w-full mt-[30px]">
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    ...
                    @empty
                        <p class="text-2xl font-bold">Question empty</p>
                    @endforelse
                </div>
            </div>
        </div>
